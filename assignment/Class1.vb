...
Public Class Class1
    Public Function Loadkhachang() As DataSet
        Dim chuoiketnoi As String = "workstation id=danhnctps02036.mssql.somee.com;packet size=4096;user id=chaudanh2kct_SQLLogin_1;pwd=4za33a7ema;data source=danhnctps02036.mssql.somee.com;persist security info=False;initial catalog=danhnctps02036"
